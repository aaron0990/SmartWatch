...
extern "C" void app_main(void)
{
    ...
    lv_color_t *buf1 = reinterpret_cast<lv_color_t *>(heap_caps_malloc(EXAMPLE_LCD_H_RES * 20 * sizeof(lv_color_t), MALLOC_CAP_DMA));
    assert(buf1);
    lv_color_t *buf2 = reinterpret_cast<lv_color_t *>(heap_caps_malloc(EXAMPLE_LCD_H_RES * 20 * sizeof(lv_color_t), MALLOC_CAP_DMA));
    assert(buf2);
