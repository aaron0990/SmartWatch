...
void ui_event_MainView(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT) {
        ...
        _ui_screen_change(&ui_FitnessActivityView, LV_SCR_LOAD_ANIM_MOVE_LEFT, 100, 0, &ui_FitnessActivityView_screen_init);
    }
}
void ui_event_FitnessActivityView(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT) {
        lv_indev_wait_release(lv_indev_get_act());
        _ui_screen_change(&ui_MainView, LV_SCR_LOAD_ANIM_MOVE_RIGHT, 100, 0, &ui_MainView_screen_init);
    }
}
...
void ui_init(void)
{
    ...
    ui_MainView_screen_init();
    ui_FitnessActivityView_screen_init();
